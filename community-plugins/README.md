...
| [`omaxian-speaker-pulseaudio-calibrator`](omaxian-speaker-pulseaudio-calibrator/) | `omaxian-speaker-pulseaudio-calibrator` | [omarchy-speaker-calibrator](https://github.com/thefreshoffice/omarchy-speaker-calibrator) — speaker PEQ; PipeWire filter-chain → PulseAudio DSP daemon + apt | Ported |
