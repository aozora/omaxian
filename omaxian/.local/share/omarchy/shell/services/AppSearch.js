...
// Display name for the launcher: title-case names that are entirely lowercase
// (e.g. "advanced network configuration"), but leave already-cased names alone
// ("Firefox", "VLC media player", "GIMP").
function entryDisplayName(entry) {
  var n = entryName(entry)
  if (n && n === n.toLowerCase())
    return n.replace(/\b([a-z])/g, function(_, c) { return c.toUpperCase() })
  return n
}
