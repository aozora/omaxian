// Original code by @mrDemonc: https://github.com/MrDemonc/Omarchy-media-control
import QtQuick
...
BarWidget {
    ...
    readonly property var activeSourcePlayers: {
        ...
        list.sort(function (a, b) {
            ...
            if (MediaHelper.isProxyPlayer(a) !== MediaHelper.isProxyPlayer(b))
                return MediaHelper.isProxyPlayer(a) ? 1 : -1;
    ...
    readonly property real trackLength: (activePlayer && !isWebSource && MediaHelper.isValidDuration(activePlayer.length)) ? MediaHelper.normalizeSeconds(activePlayer.length) : 0
    ...
    readonly property string currentTrackSignature: activePlayer ? (String(activePlayer.trackTitle || "") + "||" + String(activePlayer.trackArtist || "") + "||" + String(activePlayer.length || 0)) : ""
    ...
    Timer {
        ...
        repeat: true
        onTriggered: {
            if (!root.activePlayer || !root.hasKnownDuration)
                return;
    ...
    BarIconButton {
        ...
        iconComponent: Component {
            Text {
                ...
                color: barButton.active && barButton.useActiveColor ? (root.bar ? root.bar.foreground : Color.accent) : (root.hasMedia ? root.fg : root.dim)
                            ...
                            Row {
                                ...
                                Repeater {
                                    ...
                                    Rectangle {
                                        ...
                                        anchors.bottom: parent.bottom
                                        radius: 0
                                        color: root.isPlaying ? (root.bar ? root.bar.foreground : Color.accent) : root.dim
