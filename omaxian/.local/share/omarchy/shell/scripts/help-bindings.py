...
def describe(cmd: str) -> str:
	...
	rules: list[tuple[re.Pattern[str], str]] = [
		...
		(re.compile(r"move container to workspace next_on_output"), "Carry window to next workspace on this monitor"),
		(re.compile(r"move container to workspace prev_on_output"), "Carry window to previous workspace on this monitor"),
		(re.compile(r"move container to workspace (next|prev)"), "Carry window to adjacent workspace"),
		(re.compile(r"move workspace to output"), "Move workspace to adjacent monitor"),
		(re.compile(r"move container to output"), "Move window to adjacent monitor"),
		(re.compile(r"workspace next_on_output"), "Next workspace on this monitor"),
		(re.compile(r"workspace prev_on_output"), "Previous workspace on this monitor"),
